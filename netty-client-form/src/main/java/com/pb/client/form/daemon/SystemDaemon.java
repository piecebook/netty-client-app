            ...
            try {
                ...
                switch (rec_msg.getType()) {
                    case PBCONSTANT.ADD_FRIENDS_FLAG:
                        Add_Friend_Dialog dialog = new Add_Friend_Dialog(rec_msg.getSender(), rec_msg.getType());
                        dialog.pack();
                        dialog.setVisible(true);
                        break;
                    case PBCONSTANT.ADD_FRIENDS_ACK_FLAG:
                        Add_Friend_Dialog dialog2 = new Add_Friend_Dialog(rec_msg.getSender(), rec_msg.getType());
                        dialog2.pack();
